...
/**
 * Brian Ploeckelman created on 9/24/2015.
 */
public class EntityLinkDialog extends Dialog {

    private LevelEditorScreen levelEditorScreen;

    public EntityLinkDialog(String title, Skin skin, LevelEditorScreen levelEditorScreen) {
        super(title, skin);
    ...
    public EntityLinkDialog(String title, Skin skin, String windowStyleName, LevelEditorScreen levelEditorScreen) {
    ...
    public EntityLinkDialog(String title, Window.WindowStyle windowStyle, LevelEditorScreen levelEditorScreen) {
    ...
    protected void initLayout() {
        final EntityLinkDialog dlg = this;
